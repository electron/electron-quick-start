...
# installed.
TK_PREFIX='/c/Tclbuild/Tcl32'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/c/Tclbuild/Tcl32'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/c/Tclbuild/build32/tk8.6.4/win -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/c/Tclbuild/Tcl32/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/c/Tclbuild/build32/tk8.6.4'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/c/Tclbuild/build32/tk8.6.4/win -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/c/Tclbuild/Tcl32/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/c/Tclbuild/build32/tk8.6.4/win/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/c/Tclbuild/Tcl32/lib/libtkstub86.a'
